package com.favoriteMuisc.FavoriteMusic.security;
...
import com.favoriteMuisc.FavoriteMusic.dto.CredentialsDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
		...
		Collection<? extends GrantedAuthority> profile = ((UserSS) auth.getPrincipal()).getAuthorities();
		Integer id = ((UserSS) auth.getPrincipal()).getId();
		
        String token = jwtUtil.generateToken(username,id,profile);    
